...
mixin _$TranscriptSegment {
  ...
  SegmentSource get source => throw _privateConstructorUsedError;
...
class _$TranscriptSegmentImpl implements _TranscriptSegment {
  ...
  @override
  String toString() {
    return 'TranscriptSegment(id: $id, text: $text, timestamp: $timestamp, source: $source, confidence: $confidence)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, text, timestamp, source, confidence);
...
abstract class _TranscriptSegment implements TranscriptSegment {
  const factory _TranscriptSegment(
      ...
      required final SegmentSource source,
      final double confidence}) = _$TranscriptSegmentImpl;
